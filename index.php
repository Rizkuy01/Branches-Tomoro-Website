   ...
   <body>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="row">
                        <div class="col-md-6">
                           <div class="banner_img"><img src="images/hero-2.png" class="img-fluid custom-size"></div>
                        </div>
                        <div class="col-md-6">
      ...
      <div class="categroy_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h1 class="categroy_taital">The Benefit's</h1>
               </div>
            </div>
                     ...
                     <div class="carousel-item active">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              <h3 class="materials_text">Strong Brand</h3>
                              <p class="categroy_text">Leveraging a well-known brand allows you to attract customers more quickly and build trust in the local market, reducing the time needed to reach profitability.</p>
                           ...
                           <div class="col-md-4">
                              ...
                              <h3 class="materials_text">Business Scalability</h3>
                              <p class="categroy_text">Opening a Tomoro branch offers opportunities to expand your business on a larger scale, providing higher income potential through multiple outlets that support each other.</p>
                              <div class="readmore_btn"><a href="#">Read More</a></div>
                           </div>
                        </div>
                     </div>
